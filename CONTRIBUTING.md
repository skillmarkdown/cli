...
Successful publishes on `main` cherry-pick the automated release bump back into `development`; do not manually bump or backport `package.json` version changes into `development`.

export const ROOT_USAGE =
  "Usage: skillmd [--auth-token <token>] [--version|-v] <init|create|validate|login|logout|publish|search|view|history|install|list|remove|use|update|tag|deprecate|unpublish|whoami|org|token>";
...
export const SEARCH_USAGE =
  "Usage: skillmd search [query] [--limit <1-50>] [--cursor <token>] [--scope <public|private>] [--json] (login required)";
